...
const CATEGORIES = [
  ...
  { id: "conifers",     en: "Conifers & Topiary",      ar: "أشجار صنوبرية",
...
const PRODUCTS = [
  {
    ...
    desc: {
      ...
      ar: "الخيار الأول لأسوار التنسيق في الخليج — نمو سريع وأوراق جديدة حمراء لامعة ثلاث مرات في السنة، تتحمّل البرودة حتى −15 °م. من أكثر أصنافنا شحناً."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "بُكسس كثيف الأوراق للأسوار المشذّبة والأشكال الهندسية. مُنتَج من قطاعات معتمدة خالية من اللفحة، يتحمّل التشذيب القاسي ويحافظ على شكله طوال العام."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "سرو إيطالي مطعّم بالانتخاب لضمان القوام العمودي الصارم — تتطابق أشكاله على امتداد الجادة دون انفتاح أو انحراف، مع تحمّل ممتاز لمناخ الخليج والبحر المتوسط."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "عرعر رأسي ضيق بلون أزرق فولاذي مميز، شديد التحمّل للجفاف والحرارة والملوحة. اختيار ممتاز لتأطير المداخل وجادات المشاريع السكنية والتجارية."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "ثوجا هرمية مضغوطة ذات لون ذهبي يزداد تألقاً في الشتاء. مطعّمة على أصول ثوجا شرقية لضمان شكل هرمي موحّد دون عودة للون الأخضر مع مرور الوقت."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "أوراق داكنة تقترب من السواد مع أزهار حمراء كثيفة في الصيف — من أكثر أصناف كتالوجنا إثارةً للإعجاب. جينات Black Diamond® المرخّصة مع توثيق لكل نبتة."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "خطمي أبيض ذو أزهار مزدوجة يمتد تزهيره من يوليو حتى أكتوبر. متين ومنخفض الصيانة، يتجدّد بشكل ممتاز بعد التقليم ومناسب للمناطق الدافئة والجافة."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "دِفلى قزمي بأزهار سالمون رقيقة ينضج بارتفاع 1.2 م. الأكثر استخداماً في شوارع الخليج وطرق المشاة لمقاومته الاستثنائية للحر والملوحة وتلوث الهواء."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "ناندينا مدمجة تُزهر بأوراق مرجانية في الربيع وبرغندية في الشتاء. صنف عقيم لا ينتج بذوراً، ما يجعله آمناً بيئياً ومناسباً للمشاريع الحساسة."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "من أغمق أصناف اللوروبيتالم — أوراق داكنة شبه سوداء طوال العام تتباين مع أزهار فوشيا ربيعية لافتة. إصدار مسجّل بشهادة PlantHaven®."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "عرعر زاحف منخفض ينتشر حتى 2 م ليشكّل سجادة خضراء مزرقّة كثيفة. البديل الأمثل لمسطحات العشب في المشاريع الجافة، يستهلك 5% فقط من كميات الري التقليدية."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "إكليل الجبل الأصيل، مُهيَّأ في حقولنا المفتوحة بيالوفا. مثالي لممرات العطر وحدائق الأعشاب والحدود المزروعة بكثافة، وجاهز للشحن مباشرة لمشروعك."
    }
  },
  {
    ...
    desc: {
      ...
      ar: "كاليستيمون أسترالي بأزهار حمراء لافتة في الربيع والخريف تستقطب الطيور والملقّحات. متحمّل للتربة الفقيرة والملوحة والقلوية، ويلائم المناخات الجافة والساحلية."
    }
  },
];
...
const STRINGS = {
  ...
  ar: {
    ...
    heroTitleA: "نُصدِّر",
    heroTitleEm: "النباتات",
    heroTitleB: "من تركيا إلى الخليج",
    heroSub: "نباتات جملة ومطعّمة — سرو، فوتينيا، نباتات عطرية وشجيرات مزهرة — تُزرع وتُهيَّأ في مزرعتنا بيالوفا، ثم تُشحن مباشرة إلى مقاولي تنسيق الحدائق والمشاتل والمطوّرين في دول الخليج وأوروبا.",
    heroStat1: ["40 هكتار", "مساحة المزرعة"],
    heroStat2: ["120+", "نوع من النباتات"],
    heroStat3: ["18", "دولة نصدّر إليها"],
    sec1Eyebrow: "الكتالوج",
    sec1Title: "كتالوج عملي لمحترفي التنسيق",
    sec1Sub: "كل نبتة تُزرع وتُعبأ في مزرعتنا بيالوفا وتُشحن مباشرة إلى مشروعك.",
    sec2Eyebrow: "لماذا Bitki Hub",
    sec2Title: "مصمَّم لمشاريع التنسيق الكبيرة.",
    sec2Items: [
      { t:"إكثار مباشر في مزرعتنا", b:"كل النباتات مُكثَّرة في مشاتلنا بيالوفا — لا وسطاء، لا جينات مجهولة، وكل نبتة موثّقة من أصلها." },
      { t:"شهادات صحية معتمدة", b:"جواز سفر نباتي أوروبي لكل دفعة وشهادة صحية نباتية خاصة بكل دولة وصول لضمان التخليص الجمركي من المحاولة الأولى." },
      { t:"شحن أسبوعي من يالوفا", b:"حاويات مبرّدة ومكشوفة تغادر أسبوعياً إلى جبل علي والدمام والعقبة وميناء حمد والإسكندرية." },
      { t:"حاوية مختلطة الأصناف", b:"اجمع أكثر من 120 صنفاً في حاوية 40 قدم واحدة — الحد الأدنى لكل صنف على حدة، لا للحاوية كاملة." },
    ],
    stripItems: ["نباتات مؤقلمة من يالوفا", "شهادات صحية معتمدة", "شحن أسبوعي للخليج", "حاويات مختلطة الأصناف", "بيع الجملة فقط"],
    statsTitle: "أرقام نقيس بها أنفسنا.",
    stats: [["40", "مساحة المزرعة"], ["120+", "نوع من النباتات"], ["1.8M", "شتلة سنوياً"], ["18", "دولة نصدّر إليها"]],
    ...
    productsTitle: "كتالوج النباتات",
    productsSub: "تصفح الأنواع المتاحة، ابحث بالاسم، واطلب عرض سعر. الكتالوج الكامل (+120 نوع) متاح عند الطلب.",
    productsResultsFmt: (n, t) => `عرض ${n} من ${t} صنف`,
    sortLabel: "ترتيب:",
    sortOptions: ["الأبرز", "السعر: الأقل أولاً", "السعر: الأعلى أولاً", "الارتفاع: الأطول أولاً", "الحد الأدنى للطلب"],
    searchPlaceholder: "ابحث عن نوع النبات...",
    pdSpecsTitle: "المواصفات",
    pdSpecs: { height:"الارتفاع", pot:"حجم الصندوق", climate:"المناخ", water:"احتياجات الري", sun:"الإضاءة", age:"العمر", moq:"الحد الأدنى للشراء", origin:"بلد المنشأ" },
    pdTabs: ["الوصف", "طريقة العناية", "الشحن والتسليم"],
    pdRelated: "شتلات أخرى قد تحتاجها",
    contactTitle: "تواصل معنا",
    contactLede: "أرسل لنا قائمة مشروعك — الأنواع، الأحجام، الكميات، وميناء الوصول — وسنرد بعرض سعر وخطة تسليم خلال يوم عمل.",
    ...
    fields: {
      ...
      country:"دولة التسليم", buyer:"أنت من...",
      species:"النباتات التي تحتاجها والكميات", message:"ملاحظات إضافية",
    },
    buyers: ["مقاول تنسيق حدائق", "مطوّر عقاري", "صاحب مشتل", "أخرى"],
    submit: "إرسال الاستفسار",
    submitNote: "بالإرسال توافق على التواصل بشأن الاستفسار.",
    successTitle: "تم استلام طلبك.",
    successBody: "سنتواصل معك خلال يوم عمل",
    successBack: "إرسال آخر",
    footer: {
      tagline: "نصدّر النباتات من يالوفا، تركيا إلى دول الخليج وأوروبا.",
      colA: "الكتالوج", colAItems: ["أسوار وحواجز", "أشجار صنوبرية", "شجيرات مزهرة", "أوراق زينة", "غطاء أرضي", "نباتات متوسطية"],
      ...
      tagBottom: "من يالوفا إلى الخليج"
    },
